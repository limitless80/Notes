...
# if the validator wants to validate my code, but the output is not appearing on replit, then please run the code on your local machine by instaling the adult.data.csv file in the same directory as main.py.
